...
function CardsP3() {
    return (
        <>
            <h4 className='container mt-5 px-5' style={{ color: "black" }}>Best offer<hr /></h4>
            <div className='container'>
                <Row xs={1} md={3} lg={5} className="g-4 container row__poster">
                    {Array.from({ length: 15 }).map((_, idx) => (
                        <Col>
                            <Card className='bg-transparent border-0 p3-card'>
                                <Card.Img className='page3-img' variant="top" src="http://media.gq.com/photos/57eac35d9228bbed3f6f4ee5/master/w_2000/elon-musk-is-a-rocket.jpg" />
                                ...
                                <Card.Body className='p-0'>
                                    <Card.Text style={{ color: "black" }}>
                                        ...
                                        <p className='trip-cost'><span className='trip-cost-span'>From Price:$ <i style={{ color: "black", }} class="bi bi-infinity"></i></span>  / person</p>
                                    </Card.Text>
                                </Card.Body>
                            </Card>
                        </Col>
