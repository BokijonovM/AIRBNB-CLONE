...
function CardsP3() {
    return (
        <>
            <h3 className='container mt-5 px-5' style={{ color: "black" }}>Plan a trip with help from local Hosts around the world<hr /></h3>
            <div className='container'>
                <Row xs={2} md={3} lg={5} className="g-4 container row__poster">
                            ...
                            <Card className='bg-transparent border-0 p3-card'>
                                ...
                                <Card.Body className='p-0'>
                                    <Card.Text style={{ color: "black" }}>
                                        ...
                                        <p className='anyone-text mb-0'>Design your trip to World with me</p>
